...
//$userids = get_post_meta($order->ID, '_customer_user',true);
//$firstname = get_user_meta($userids, 'first_name', true);
//if (empty($firstname)) {
//    $firstname = get_user_meta($userids, 'billing_first_name', true);
//}
//$lastname = get_user_meta($userids, 'last_name', true);
//if (empty($lastname)) {
//    $lastname = get_user_meta($userids, 'billing_last_name', true);
//}
            ...
            <div class="row">
                ...
                <!--         <td></td>-->
                    ...
                    <p> <?php
                        ...
                        echo $paymenttypeSearch[$payment_type];
                        ?>
                    </p>
                    <p>
