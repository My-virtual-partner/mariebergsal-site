                    ...
                    <div class="modal-body help_offert_section">
                        ...
                        <div id="steps_info_modal" style="display: block;margin-top: 10px;">
                            ...
                            foreach ($project_roles_steps as $single_step) {
                                if ($project_type === $single_step["project_type_id"]):
                        ...
                        <div class="row top-buffer">
                            ...
                            ?>
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><?php echo __('Kund: ') . "<strong>" . $current_customer_id . " - " . $firstname . " " . $lastname . "</strong>"; ?>
                                    </li>
                                    <li>
...
//print_r(completed_step_value);
                    ...
                    <?php else : ?>
                        <div class="col-lg-2<!-- --><?php /* echo $offset_class; */ ?> col-md-2 col-sm-2">
