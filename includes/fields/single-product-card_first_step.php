            ...
            <span>
                ...
                if ($product > 0) {
                    ...
                    echo '<p
                                ...
                                class=""
                                id="" style="padding-left: 5px;padding-right: 5px;">' . $p_regular_price_decemal . ' exkl moms
                            </p>';
                    echo '<p
                                
                              
                                class=""
                                id="" style="padding-left: 5px;padding-right: 5px;">' . wc_price($product->get_price_including_tax()) . ' inkl moms
                            </p>';
                } else {
                    echo '<p
...
?>"
                ...
                if (!$attributes) : ?>
                    ...
                    <li>
                        <button
                                type="button"
                                data-product-id="<?php the_ID(); ?>" data-head="true"
